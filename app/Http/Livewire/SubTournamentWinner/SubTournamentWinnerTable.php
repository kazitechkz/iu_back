...
namespace App\Http\Livewire\SubTournamentWinner;
...
class SubTournamentWinnerTable extends DataTableComponent
{
    protected $model = SubTournamentWinner::class;
    ...
    public function deleteSelected(): void
    {
        ...
        foreach ($subjects as $key => $value) {
            $sub = SubTournamentWinner::find($value);
            $sub?->delete();
        }
        $this->clearSelected();
    }
