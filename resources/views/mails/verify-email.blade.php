...
<div class="container">
    ...
    <div class="card p-6 p-lg-10 space-y-4">
        ...
        <p>
            Для завершения регистрации на сайте введите ниже приведенный код:
        </p>
...
{{--        <h3 class="text-2xl">Спасибо за регистрацию на iutest.kz!</h3>--}}
...
{{--            </svg>--}}
{{--        </div>--}}
{{--        <p>Для завершения регистрации на сайте введите ниже приведенный код:</p>--}}
{{--        <div class="mt-4">--}}
{{--            <button type="button" class="px-2 py-2 text-blue-200 bg-blue-600 rounded">{{$code}}</button>--}}
{{--        </div>--}}
{{--    </div>--}}
{{--</div>--}}
