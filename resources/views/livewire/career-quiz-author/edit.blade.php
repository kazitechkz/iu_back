<x-form-component.form-component
    :method="'put'"
    :parameters="['career_quiz_author'=>$careerQuizAuthor]"
    :route="'career-quiz-author.update'"
...
>
    ...
    <livewire:image-upload :id="$careerQuizAuthor->image_url" :folder-name="'career_author'"/>
    {{-- Image Url --}}
    {{--    Position Ru --}}
    <div class="form-group">
        <x-input class="my-2"
