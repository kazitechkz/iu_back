<x-form-component.form-component
    :method="'put'"
    :route="'iutube-author.update'"
    :parameters="['iutube_author'=>$author]"
    :element-id="'iutube-author-update'"
>
    {{-- Image Url --}}
    <label class="h-5">{{__('table.image_url')}}*</label>
    <livewire:image-upload :id="$author->image_url != null ? $author->image_url : 0"  :folder-name="'iutube-author'"/>
    {{-- Image Url --}}
    {{--    User Name--}}
