<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
        ...
        />
            ...
            <x-shared.sidebar-menu :element-id="'users'" :name="__('sidebar.user')"
                                   :icon="'fas fa-solid fa-building-shield'">
                <x-shared.sub-sidebar-menu :icon="'fa fa-user'" :link="'user.index'" :name="__('sidebar.user')"/>
                <x-shared.sub-sidebar-menu :icon="'fas fa-person-military-pointing'" :link="'role.index'"
                                           :name="__('sidebar.role')"/>
                <x-shared.sub-sidebar-menu :icon="'fas fa-hand'" :link="'permission.index'"
        ...
        @can('subject create')
            <x-shared.sidebar-menu :element-id="'subjects'" :name="__('sidebar.subject')" :icon="'fas fa-book'">
                ...
                <x-shared.sub-sidebar-menu :icon="'fas fa-list'" :link="'categories.index'"
                                           :name="__('sidebar.categories')"/>
                <x-shared.sub-sidebar-menu :icon="'fas fa-edit'" :link="'single-tests.index'"
        ...
        <x-shared.sidebar-menu :element-id="'finance'" :name="__('sidebar.finance')" :icon="'mdi mdi-currency-usd'">
            ...
            <x-shared.sub-sidebar-menu :icon="' mdi mdi-compass-outline'" :link="'plan-combination.index'"
                                       :name="__('sidebar.plan-combination')"/>
            <x-shared.sub-sidebar-menu :icon="'fas fa-handshake'" :link="'subscription.index'"
        ...
        <x-shared.sidebar-menu :element-id="'support'" :name="__('sidebar.support')" :icon="' mdi mdi-human-handsup'">
            <x-shared.sub-sidebar-menu :icon="'mdi mdi-comment-question-outline'" :link="'appeal.index'"
                                       :name="__('sidebar.appeal')"/>
            <x-shared.sub-sidebar-menu :icon="'mdi mdi-comment-alert-outline'" :link="'appeal-type.index'"
        ...
        <x-shared.sidebar-menu :element-id="'tests'" :name="__('sidebar.tests')" :icon="'fas fa-wallet'">
            ...
            <x-shared.sub-sidebar-menu :icon="'mdi mdi-language-python'" :link="'subject-contexts.index'"
                                       :name="__('sidebar.context')"/>
            <x-shared.sub-sidebar-menu :icon="'mdi mdi-vector-point'" :link="'questions.index'"
        ...
        <x-shared.sidebar-menu :element-id="'tournament'" :name="__('sidebar.tournament')" :icon="'fas fa-trophy'">
            <x-shared.sub-sidebar-menu :icon="'fas fa-trophy'" :link="'tournament.index'"
                                       :name="__('sidebar.tournament')"/>
            <x-shared.sub-sidebar-menu :icon="'fas fa-trophy'" :link="'sub-tournament.index'"
                                       :name="__('sidebar.sub-tournament')"/>
            <x-shared.sub-sidebar-menu :icon="'fas fa-users'" :link="'sub-tournament-participant.index'"
                                       :name="__('sidebar.sub-tournament-participant')"/>
            <x-shared.sub-sidebar-menu :icon="'fas fa-award'" :link="'sub-tournament-winner.index'"
                                       :name="__('sidebar.sub-tournament-winner')"/>
            <x-shared.sub-sidebar-menu :icon="'fas fa-square-poll-vertical'" :link="'sub-tournament-result.index'"
                                       :name="__('sidebar.sub-tournament-result')"/>
            <x-shared.sub-sidebar-menu :icon="'mdi mdi-sword'" :link="'sub-tournament-rival.index'"
